...
/** host to get JSON data. */
var host = 'alscan.info.test';
...
function main() {
    ...
    getJSON('http://alscan.info.test/agent_groups/groups.json', function (groups) {
        var s = JSON.stringify(groups);
        database.write("groups:" + s + ",\n");
        testFile = fs.createWriteStream('./test/groups.json', { flags: 'w', encoding: 'utf8' });
        testFile.write(s+"\n");
        testFile.end();
        getJSON('http://alscan.info.test/agent_sources/sources.json', function (sources) {
            ...
            testFile.write(s+"\n");
            testFile.end();
            getJSON('http://alscan.info.test/patterns/patterns.json', function (patterns) {
                ...
                testFile.end();
                getJSON('http://alscan.info.test/agents/agents.json', function (agents) {
